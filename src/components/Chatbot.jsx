        ...
        return (
          <div style={{ position: 'relative' }}>
            <button
              ...
              style={{ position: 'absolute', top: 0, right: 0, background: 'none', border: 'none', fontSize: 22, color: '#333', zIndex: 2, padding: 4 }}
            >
              ×
            </button>
                ...
                <>
                  ...
                  <div className="mb-2" style={{ color: '#000' }}>
                    <PhoneInput
                      ...
                      inputStyle={{ width: '100%', height: '38px', borderRadius: '0.375rem', background: '#fff', color: '#222' }}
