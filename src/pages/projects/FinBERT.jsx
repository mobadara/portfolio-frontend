...
const FinBERT = () => {
  ...
  return (
    <>
        ...
        <Container>
          <div className="section-shell">
            <div className="text-center mb-5 py -3">
              <h2 className="fw-bold display-6 text-navy">Financial News Sentiment Analyzer</h2>
              <p className="text-muted">
                Explore this interactive demo of my FinBERT-powered sentiment analysis tool for financial news. Enter a headline to instantly see whether the model predicts a bullish, bearish, or neutral outlook—showcasing real-time NLP capabilities for portfolio insights.
                <br />
      ...
      <footer style={{ margin: '2rem 0', textAlign: 'center' }}>
        <Button variant="outline-primary" href="/projects" className="text-muted">
